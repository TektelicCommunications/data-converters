	...
	decoder = [
		...
		},
		{
			...
			fn: function(arg) { 
				...
				{switch (val){
					case 0:
						decoded_data['ble_display_whitelisting_enabled'] = "Disable";
						break;
					case 1:
						decoded_data['ble_display_whitelisting_enabled'] = "Enable";
						break;
					default:
		...
		},
		{
			key: [0x2B],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('display_format_options')) {
					decoded_data['display_format_options'] = {};
				}
				var val = decode_field(arg, 1, 0, 0, "unsigned");
				{switch (val){
					case 0:
						decoded_data['display_format_options']['ble_display_language'] = "English";
						break;
					case 1:
						decoded_data['display_format_options']['ble_display_language'] = "French";
						break;
					default:
						decoded_data['display_format_options']['ble_display_language'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 4, 4, "unsigned");
				{switch (val){
					case 0:
						decoded_data['display_format_options']['ble_display_temperature_unit'] = "Celsius";
						break;
					case 1:
						decoded_data['display_format_options']['ble_display_temperature_unit'] = "Fahrenheit";
						break;
					default:
						decoded_data['display_format_options']['ble_display_temperature_unit'] = "Invalid";
				}}
				return 1;
			}
		},
		...
		},
		{
			key: [0x47],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('light_sampling_parameters')) {
					decoded_data['light_sampling_parameters'] = {};
				}
				decoded_data['light_sampling_parameters']['light_sample_period'] = decode_field(arg, 3, 23, 8, "unsigned");
				decoded_data['light_sampling_parameters']['light_num_subsamples'] = decode_field(arg, 3, 7, 0, "unsigned");
				return 3;
			}
		},
		{
			key: [0x48],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('light_threshold_control')) {
					decoded_data['light_threshold_control'] = {};
				}
				decoded_data['light_threshold_control']['light_threshold_level'] = decode_field(arg, 2, 15, 0, "unsigned") * 0.1;
				return 2;
			}
		},
		{
			key: [0x49],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('light_report_options')) {
					decoded_data['light_report_options'] = {};
				}
				var val = decode_field(arg, 1, 0, 0, "unsigned");
				{switch (val){
					case 0:
						decoded_data['light_report_options']['light_state_reported'] = "Not Reported";
						break;
					case 1:
						decoded_data['light_report_options']['light_state_reported'] = "Reported";
						break;
					default:
						decoded_data['light_report_options']['light_state_reported'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 1, 1, "unsigned");
				{switch (val){
					case 0:
						decoded_data['light_report_options']['light_intensity_reported'] = "Not Reported";
						break;
					case 1:
						decoded_data['light_report_options']['light_intensity_reported'] = "Reported";
						break;
					default:
						decoded_data['light_report_options']['light_intensity_reported'] = "Invalid";
				}}
				return 1;
			}
		},
...
if (input.fPort === 10) {
	decoder = [
		...
		},
		{
			key: [0x10, 0x02],
			fn: function(arg) { 
				decoded_data['light_intensity'] = (decode_field(arg, 2, 15, 0, "unsigned") * 0.1).toFixed(1);
				return 2;
			}
		},
	];
