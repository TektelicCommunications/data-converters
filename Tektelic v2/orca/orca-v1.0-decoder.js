...
if (input.fPort === 100) {
	decoder = [
		...
		},
		{
			key: [0x31],
			fn: function(arg) { 
				decoded_data['speed_threshold'] = (decode_field(arg, 2, 15, 8, "unsigned") * 0.1).toFixed(1);
				return 2;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['num_satellites'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['num_satellites'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['num_satellites'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 1, 1, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['avg_satellite_snr'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['avg_satellite_snr'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['avg_satellite_snr'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 2, 2, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['fix_type'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['fix_type'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['fix_type'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 3, 3, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['time_to_fix'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['time_to_fix'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['time_to_fix'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 4, 4, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['log_num'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['log_num'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['log_num'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 5, 5, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_diagnostics_tx']['ghost_error_cnt'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_diagnostics_tx']['ghost_error_cnt'] = "Enable";
						break;
					default:
						decoded_data['gnss_diagnostics_tx']['ghost_error_cnt'] = "Invalid";
				}}
				return 1;
			}
		},
		{
			key: [0x33],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('gnss_data_tx')) {
					decoded_data['gnss_data_tx'] = {};
				}
				var val = decode_field(arg, 1, 0, 0, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_data_tx']['utc'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_data_tx']['utc'] = "Enable";
						break;
					default:
						decoded_data['gnss_data_tx']['utc'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 1, 1, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_data_tx']['coordinates'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_data_tx']['coordinates'] = "Enable";
						break;
					default:
						decoded_data['gnss_data_tx']['coordinates'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 2, 2, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_data_tx']['ground_speed'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_data_tx']['ground_speed'] = "Enable";
						break;
					default:
						decoded_data['gnss_data_tx']['ground_speed'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 3, 3, "unsigned");
				{switch (val){
					case 0:
						decoded_data['gnss_data_tx']['geofence'] = "Disable";
						break;
					case 1:
						decoded_data['gnss_data_tx']['geofence'] = "Enable";
						break;
					default:
						decoded_data['gnss_data_tx']['geofence'] = "Invalid";
				}}
				return 1;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['geofence0']['fence_longitude_0'] = (decode_field(arg, 8, 39, 16, "signed") * 0.000025).toFixed(6);
				decoded_data['geofence0']['fence_latitude_0'] = (decode_field(arg, 8, 63, 40, "signed") * 0.0000125).toFixed(7);
				return 8;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['geofence1']['fence_radius_1'] = decode_field(arg, 8, 15, 0, "unsigned") * 10;
				decoded_data['geofence1']['fence_longitude_1'] = (decode_field(arg, 8, 39, 16, "signed") * 0.000025).toFixed(6);
				decoded_data['geofence1']['fence_latitude_1'] = (decode_field(arg, 8, 63, 40, "signed") * 0.0000125).toFixed(7);
				return 8;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['geofence2']['fence_radius_2'] = decode_field(arg, 8, 15, 0, "unsigned") * 10;
				decoded_data['geofence2']['fence_longitude_2'] = (decode_field(arg, 8, 39, 16, "signed") * 0.000025).toFixed(6);
				decoded_data['geofence2']['fence_latitude_2'] = (decode_field(arg, 8, 63, 40, "signed") * 0.0000125).toFixed(7);
				return 8;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['geofence3']['fence_radius_3'] = decode_field(arg, 8, 15, 0, "unsigned") * 10;
				decoded_data['geofence3']['fence_longitude_3'] = (decode_field(arg, 8, 39, 16, "signed") * 0.000025).toFixed(6);
				decoded_data['geofence3']['fence_latitude_3'] = (decode_field(arg, 8, 63, 40, "signed") * 0.0000125).toFixed(7);
				return 8;
			}
		},
		{
		...
		},
		{
			...
			fn: function(arg) { 
				...
				{switch (val){
					case 0:
						decoded_data['ble_mode']['repetition_enabled'] = "Disable";
						break;
					case 1:
						decoded_data['ble_mode']['repetition_enabled'] = "Enable";
						break;
					default:
						decoded_data['ble_mode']['repetition_enabled'] = "Invalid";
				}}
				return 1;
			}
		},
		...
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['bd_addr_range0']['lap_end_0'] = decode_field(arg, 9, 23, 0, "hexstring");
				decoded_data['bd_addr_range0']['lap_start_0'] = decode_field(arg, 9, 47, 24, "hexstring");
				decoded_data['bd_addr_range0']['oui_0'] = decode_field(arg, 9, 71, 48, "hexstring");
				return 9;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['bd_addr_range1']['lap_end_1'] = decode_field(arg, 9, 23, 0, "hexstring");
				decoded_data['bd_addr_range1']['lap_start_1'] = decode_field(arg, 9, 47, 24, "hexstring");
				decoded_data['bd_addr_range1']['oui_1'] = decode_field(arg, 9, 71, 48, "hexstring");
				return 9;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['bd_addr_range2']['lap_end_2'] = decode_field(arg, 9, 23, 0, "hexstring");
				decoded_data['bd_addr_range2']['lap_start_2'] = decode_field(arg, 9, 47, 24, "hexstring");
				decoded_data['bd_addr_range2']['oui_2'] = decode_field(arg, 9, 71, 48, "hexstring");
				return 9;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['bd_addr_range3']['lap_end_3'] = decode_field(arg, 9, 23, 0, "hexstring");
				decoded_data['bd_addr_range3']['lap_start_3'] = decode_field(arg, 9, 47, 24, "hexstring");
				decoded_data['bd_addr_range3']['oui_3'] = decode_field(arg, 9, 71, 48, "hexstring");
				return 9;
			}
		},
		{
		...
		},
		{
			...
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('log_all')) {
					...
					var data = [];
					var prefix = {};
					prefix['fragment_number_3'] = decode_field(arg, 17, 135, 128, "unsigned");
					data.push(prefix);
					arg = arg.slice(1);
