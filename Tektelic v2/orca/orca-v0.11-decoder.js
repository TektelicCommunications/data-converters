	...
	decoder = [
		...
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['battery1_status']['voltage_1'] = (decode_field(arg, 1, 6, 0, "unsigned") * 0.01).toFixed(2);
				var val = decode_field(arg, 1, 7, 7, "unsigned");
				{switch (val){
					case 0:
		...
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['battery2_status']['voltage_2'] = (decode_field(arg, 1, 6, 0, "unsigned") * 0.01).toFixed(2);
				var val = decode_field(arg, 1, 7, 7, "unsigned");
				{switch (val){
					case 0:
		...
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['coordinates']['altitude_position'] = (decode_field(arg, 9, 15, 0, "signed") * 0.5).toFixed(1);
				decoded_data['coordinates']['longitude_position'] = (decode_field(arg, 9, 47, 16, "signed") * 0.0000001).toFixed(7);
