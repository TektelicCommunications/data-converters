...
if (input.fPort === 100) {
	decoder = [
		...
		},
		{
			key: [0x2A],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('fb_mode')) {
					decoded_data['fb_mode'] = {};
				}
				var val = decode_field(arg, 2, 15, 15, "unsigned");
				{switch (val){
					case 0:
						decoded_data['fb_mode']['mcu_event_type'] = "Type 1";
						break;
					case 1:
						decoded_data['fb_mode']['mcu_event_type'] = "Type 2";
						break;
					default:
						decoded_data['fb_mode']['mcu_event_type'] = "Invalid";
				}}
				var val = decode_field(arg, 2, 3, 3, "unsigned");
				{switch (val){
					case 0:
						decoded_data['fb_mode']['mcu_ble_scan'] = "Disable";
						break;
					case 1:
						decoded_data['fb_mode']['mcu_ble_scan'] = "Enable";
						break;
					default:
						decoded_data['fb_mode']['mcu_ble_scan'] = "Invalid";
				}}
				var val = decode_field(arg, 2, 2, 2, "unsigned");
				{switch (val){
					case 0:
						decoded_data['fb_mode']['mcu_temp'] = "Disable";
						break;
					case 1:
						decoded_data['fb_mode']['mcu_temp'] = "Enable";
						break;
					default:
						decoded_data['fb_mode']['mcu_temp'] = "Invalid";
				}}
				var val = decode_field(arg, 2, 1, 1, "unsigned");
				{switch (val){
					case 0:
						decoded_data['fb_mode']['mcu_accl_vector'] = "Disable";
						break;
					case 1:
						decoded_data['fb_mode']['mcu_accl_vector'] = "Enable";
						break;
					default:
						decoded_data['fb_mode']['mcu_accl_vector'] = "Invalid";
				}}
				var val = decode_field(arg, 2, 0, 0, "unsigned");
				{switch (val){
					case 0:
						decoded_data['fb_mode']['mcu_battery_voltage_report'] = "Disable";
						break;
					case 1:
						decoded_data['fb_mode']['mcu_battery_voltage_report'] = "Enable";
						break;
					default:
		...
		},
		{
			key: [0x2B],
			fn: function(arg) { 
				if(!decoded_data.hasOwnProperty('event_type_I')) {
					decoded_data['event_type_I'] = {};
				}
				decoded_data['event_type_I']['n_value'] = decode_field(arg, 1, 7, 4, "unsigned");
				decoded_data['event_type_I']['m_value'] = decode_field(arg, 1, 3, 0, "unsigned");
				return 1;
			}
		},
		{
			key: [0x2C],
			fn: function(arg) { 
				decoded_data['fb_event_type2_t_value'] = decode_field(arg, 1, 3, 0, "unsigned");
				return 1;
			}
		},
		{
		...
		},
		{
			key: [0x42],
			fn: function(arg) { 
				decoded_data['motion_accl_trigger_threshold_count'] = decode_field(arg, 2, 15, 0, "unsigned");
				return 2;
			}
		},
		{
			key: [0x43],
			fn: function(arg) { 
				decoded_data['motion_accl_trigger_threshold_period'] = decode_field(arg, 2, 15, 0, "unsigned");
				return 2;
			}
		},
		{
			key: [0x44],
			fn: function(arg) { 
				decoded_data['motion_accl_trigger_threshold'] = decode_field(arg, 2, 15, 0, "unsigned");
				return 2;
			}
		},
		{
			key: [0x45],
			fn: function(arg) { 
				decoded_data['motion_accl_event_grace_period'] = decode_field(arg, 2, 15, 0, "unsigned");
				return 2;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				{switch (val){
					case 0:
						decoded_data['acceleration_event_tx']['motion_accl_assist_ble'] = "Disable";
						break;
					case 1:
						decoded_data['acceleration_event_tx']['motion_accl_assist_ble'] = "Enable";
						break;
					default:
						decoded_data['acceleration_event_tx']['motion_accl_assist_ble'] = "Invalid";
				}}
				var val = decode_field(arg, 1, 0, 0, "unsigned");
				{switch (val){
					case 0:
						decoded_data['acceleration_event_tx']['motion_accl_alarms'] = "Disable";
						break;
					case 1:
						decoded_data['acceleration_event_tx']['motion_accl_alarms'] = "Enable";
						break;
					default:
						decoded_data['acceleration_event_tx']['motion_accl_alarms'] = "Invalid";
				}}
				return 1;
			}
		},
