...
if (input.fPort === 100) {
	decoder = [
		...
		},
		{
			key: [0x24],
			fn: function(arg) { 
				decoded_data['bsm_report_period'] = decode_field(arg, 1, 7, 0, "unsigned");
				return 1;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['parameters']['time_percentage'] = decode_field(arg, 1, 7, 4, "unsigned") * 0.1;
				decoded_data['parameters']['intensity'] = decode_field(arg, 1, 0, 3, "unsigned") * 0.1;
				return 1;
			}
		},
		{
			...
			fn: function(arg) { 
				...
				decoded_data['fw_ver']['app_ver_major'] = decode_field(arg, 7, 55, 48, "unsigned");
				decoded_data['fw_ver']['app_ver_minor'] = decode_field(arg, 7, 47, 40, "unsigned");
				decoded_data['fw_ver']['app_revision'] = decode_field(arg, 7, 39, 32, "unsigned");
				decoded_data['fw_ver']['loramac_ver_major'] = decode_field(arg, 7, 31, 24, "unsigned");
				decoded_data['fw_ver']['loramac_ver_minor'] = decode_field(arg, 7, 23, 16, "unsigned");
				decoded_data['fw_ver']['loramac_ver_revision'] = decode_field(arg, 7, 15, 8, "unsigned");
	...
	decoder = [
		{
			...
			fn: function(arg) { 
				...
				{switch (val){
					case 0:
						decoded_data['reporting_mode'] = "Normal Reporting Mode";
						break;
					case 1:
						decoded_data['reporting_mode'] = "Enhanced Reporting Mode";
						break;
					default:
						decoded_data['reporting_mode'] = "Invalid";
				}}
				var val = decode_field(arg, 9, 62, 62, "unsigned");
				{switch (val){
					case 0:
						decoded_data['battery_saving_mode'] = "Not in battery saving mode";
						break;
					case 1:
						decoded_data['battery_saving_mode'] = "In battery saving mode";
						break;
					default:
						decoded_data['battery_saving_mode'] = "Invalid";
				}}
				var val = decode_field(arg, 9, 59, 50, "unsigned");
				{switch (val){
					case 1023:
				...
				var val = decode_field(arg, 9, 14, 8, "unsigned");
				{switch (val){
					case 127:
