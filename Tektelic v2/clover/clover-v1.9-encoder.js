var sensor = 
{
    ...
    "threshold": {
        "temperature_relative_humidity_idle": {
            "header": "0x30",
            "data_size": 4,
            "bit_start": 31,
            "bit_end": 0,
        ...
        "temperature_relative_humidity_active": {
            "header": "0x31",
            "data_size": 4,
            "bit_start": 31,
            "bit_end": 0,
...
function write_to_port(bytes, port, encoded_data) {
	// write port to "fPort" in "encoded_data"
	encoded_data["fPort"] = port;
	// write bytes to the "bytes" in "encoded_data"
